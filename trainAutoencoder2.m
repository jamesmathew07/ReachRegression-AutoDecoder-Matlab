function [autoenc autonet net] = trainAutoencoder2(X, varargin)
...
paramsStruct  = Autoencoder2.parseInputArguments(varargin{:});
autonet = Autoencoder2.createNetwork(paramsStruct);
[autoenc net] = Autoencoder2.train(X, autonet, paramsStruct.UseGPU);
%   dec         = Autoencoder2.getDecoder(autoenc)
end